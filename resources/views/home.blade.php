<x-app>
    ...
    <div class="relative w-full h-[90vh] flex flex-col lg:flex-row items-center bg-gray-100 px-6 sm:px-10">
        ...
        <div class="w-full lg:w-1/2 text-center lg:text-left">
            <p class="text-blue-700 text-4xl sm:text-6xl font-extrabold leading-tight">
                Bienvenue
            </p>
            ...
            <div class="mt-6 w-full flex justify-start">
                <a
                    class="bg-blue-700 flex items-center justify-center px-8 md:w-[200px] w-full text-white text-lg sm:text-xl font-semibold px-6 py-3 rounded-lg shadow-lg hover:bg-blue-800 transition duration-300"
    ...
    <div class="text-center py-6" id="start">
        <h1 class="text-3xl font-bold text-blue-700">Choisissez votre bus</h1>
    ...
    <div class="max-w-4xl mx-auto p-4">
        <div class=" grid grid-cols-2  md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 sm:gap-6">
            ...
            <a href="{{route('bus.track',$bu->id) }}"
                class="mx-auto flex flex-col items-center justify-center h-20 w-20 sm:h-24 sm:w-24 bg-blue-500 text-white text-lg sm:text-xl font-bold rounded-lg shadow-md cursor-pointer hover:bg-blue-600 transition duration-300">
                <!-- Bus Icon -->
